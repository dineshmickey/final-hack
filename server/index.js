...
app.get('/complaint/:comp',function(req,res){
	var sendgrid = new SendGrid('vishnus','ghtj');
	var c=req.params.comp;
sendgrid.send({
  to: 'balu@gyanmatrix.com',
  from: 'vishnu.gmx@gmail.com',
  subject: 'Complaints',
  text: req.params.comp
},function(err,res)
{
	if(err)
		console.error(err);
